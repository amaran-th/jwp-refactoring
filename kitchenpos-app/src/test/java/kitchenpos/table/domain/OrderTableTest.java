...
class OrderTableTest {
    ...
    void updateNumberOfGuests() {
        //given
        final NumberOfGuests before = NumberOfGuests.DEFAULT_NUMBER_OF_GUESTS;
    ...
    void updateEmpty() {
        ...
        final OrderTable orderTable = new OrderTable(NumberOfGuests.DEFAULT_NUMBER_OF_GUESTS, before);

...
class TableGroupServiceTest extends ServiceIntegrateTest {
    ...
    void ungroup_success() {
        ...
        assertAll(
                () -> Assertions.assertThat(orderTableDao.findById(1L).get().isEmpty()).isFalse(),
                () -> Assertions.assertThat(orderTableDao.findById(2L).get().isEmpty()).isFalse(),
                () -> Assertions.assertThat(orderTableDao.findById(1L).get().getTableGroupId()).isNull(),
                () -> Assertions.assertThat(orderTableDao.findById(2L).get().getTableGroupId()).isNull()
        );
    }

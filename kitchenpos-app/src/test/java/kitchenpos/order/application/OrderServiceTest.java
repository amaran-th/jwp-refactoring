...
class OrderServiceTest extends ServiceIntegrateTest {
    ...
    void create_success() {
        ...
        Assertions.assertAll(
                ...
                () -> org.assertj.core.api.Assertions.assertThat(actual.getOrderStatus()).isEqualTo(OrderStatus.COOKING.name())
        );
    ...
    void changeOrderStatus_success() {
        ...
        //then
        org.assertj.core.api.Assertions.assertThat(actual.getOrderStatus()).isEqualTo(newStatus.name());
    }
